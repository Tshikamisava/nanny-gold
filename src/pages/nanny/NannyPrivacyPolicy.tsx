...
export default function NannyPrivacyPolicy() {
  return (
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <section>
            ...
            <ul className="text-muted-foreground text-sm space-y-2 ml-6 list-disc">
          ...
          <section>
            <h3 className="text-lg font-semibold text-primary mb-3">4. Sharing and Disclosure</h3>
            <p className="text-muted-foreground text-sm">
          ...
          <section>
            <h3 className="text-lg font-semibold text-primary mb-3">5. Data Retention</h3>
            <p className="text-muted-foreground text-sm">
          ...
          <section>
            <h3 className="text-lg font-semibold text-primary mb-3">6. Your Rights</h3>
            <p className="text-muted-foreground text-sm mb-3">
          ...
          <section>
            <h3 className="text-lg font-semibold text-primary mb-3">7. Data Security</h3>
            <p className="text-muted-foreground text-sm">
          ...
          <section>
            <h3 className="text-lg font-semibold text-primary mb-3">8. Cookies and Tracking</h3>
            <p className="text-muted-foreground text-sm">
          ...
          <section>
            <h3 className="text-lg font-semibold text-primary mb-3">9. Contact Us</h3>
            <p className="text-muted-foreground text-sm mb-3">
