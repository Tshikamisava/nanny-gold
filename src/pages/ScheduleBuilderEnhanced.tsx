...
const ScheduleBuilder = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-50 to-yellow-50 px-6 py-8">
              ...
              <div key={index} className="flex items-center space-x-2 mb-4">
                <div className="flex-1">
                  ...
                  <input 
                    ...
                    className="w-full p-2 border border-fuchsia-200 rounded-lg focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-200" 
                    min="00:00" 
                    max="23:59" 
                  />
                </div>
