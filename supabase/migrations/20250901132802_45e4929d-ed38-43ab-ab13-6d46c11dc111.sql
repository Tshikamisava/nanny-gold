-- Fix handle_new_user function to not hardcode nanny profile values and properly set user_type metadata
...
BEGIN
  ...
  BEGIN
    ...
    IF user_type_val = 'nanny' THEN
      -- Create nanny profile with customizable defaults (not hardcoded)
