...
BEGIN
  ...
  -- Log admin action
  INSERT INTO public.admin_booking_actions (
    booking_id,
    admin_id,
    action_type,
    reason,
...
-- Create admin booking actions audit table
CREATE TABLE IF NOT EXISTS public.admin_booking_actions (
...
-- Enable RLS on admin_booking_actions
ALTER TABLE public.admin_booking_actions ENABLE ROW LEVEL SECURITY;

-- Create RLS policies for admin_booking_actions
CREATE POLICY "Admins can manage booking actions" ON public.admin_booking_actions
