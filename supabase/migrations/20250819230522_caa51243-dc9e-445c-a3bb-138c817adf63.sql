...
DROP POLICY IF EXISTS "Users can view room participants for their rooms" ON public.chat_room_participants;
DROP POLICY IF EXISTS "Users can insert themselves as participants" ON public.chat_room_participants;
